...
import type { PositionV7 } from '../src/game/v7';
...
function position(caps: ChainCap[], slot = 0): PositionV7 {
...
const run = (p: PositionV7) => previewTurn(p.game, p.hand, p.definitions, p.layout, greedyStrategy.chooseTurn(p));
