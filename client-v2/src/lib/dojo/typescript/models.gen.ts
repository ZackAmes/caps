...
// Type definition for `caps::planetelo::Status` enum
export const status = [
	'None',
	'Active',
	'Draw',
...
export type Status = { [key in typeof status[number]]: string };
export type StatusEnum = CairoCustomEnum;
